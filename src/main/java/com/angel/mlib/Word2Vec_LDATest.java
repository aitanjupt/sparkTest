...
spark-test-1.0.jar
 */
public class Word2Vec_LDATest implements Serializable {

    static final Word2Vec word2Vec = new Word2Vec();

    public static void main(String[] args) {
        SparkConf conf = new SparkConf().setAppName("Word2Vec_LDATest");
        JavaSparkContext sc = new JavaSparkContext(conf);
        // Load and parse the data
        String path = "/dw_ext/mllib/Word2Vec_LDA.test";
...
//                    int i = hashingTF.indexOf(s);
        ...
        wordListRDD.repartition(1).saveAsTextFile("/dw_ext/mllib/Word2Vec_LDATestWordList.out");

        JavaRDD<Vector> parsedData = getWord2Vec(documentsParsed);
...
//        dds.repartition(1).saveAsTextFile("/dw_ext/mllib/Word2Vec_LDATest.out");
...
//        }
    ...
    private static JavaRDD<Vector> getWord2Vec(JavaRDD<Iterable<String>> documentsParsed) {

        Word2VecModel model = word2Vec.fit(documentsParsed);
//Doc2VecModel
