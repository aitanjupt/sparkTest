...
/*
spark-submit --master yarn-client --class com.angel.mlib.RandomForestClassificationWeatherTest \
...
spark-test-1.0.jar
 */
public class RandomForestClassificationWeatherTest implements Serializable {
