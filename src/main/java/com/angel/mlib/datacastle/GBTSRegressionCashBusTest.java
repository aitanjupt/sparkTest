...
/*
spark-submit --master yarn-client --class com.angel.mlib.datacastle.GBTSRegressionCashBusTest \
...
spark-test-1.0.jar
 */
public class GBTSRegressionCashBusTest implements Serializable {

    public static void main(String[] args) {
        SparkConf conf = new SparkConf().setAppName("GBTSRegressionCashBusTest");
        JavaSparkContext jsc = new JavaSparkContext(conf);
        // Load and parse the data
        String datapath = "/dw_ext/mllib/CashBus.training0+1";
...
// Split the data into training and test sets (30% held out for testing)
        ...
        final GradientBoostedTreesModel model = TrainCashBus.trainGBTSRegression(trainingData, cfInfo);
...
//        System.out.println("Learned classification forest model:\n" + model.toDebugString());
    ...
    private static void test(JavaRDD<LabeledPoint> testData, final GradientBoostedTreesModel model) {
